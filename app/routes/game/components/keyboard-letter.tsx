...
export const KeyboardLetter = ({
  ...
  return (
    <button
      onMouseDown={action}
      className={cn(
        "flex justify-center text-darkNavy bg-white rounded-lg md:rounded-3xl xl:rounded-[1.875rem] py-[1.1875rem] md:py-[1.5625rem] w-[1.8125rem] md:w-16 xl:w-[6.8125rem]",
        {
